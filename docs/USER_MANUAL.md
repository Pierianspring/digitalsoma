...
**Version 2.1.0** — Dr. ir. Ali Youssef (ORCID: 0000-0002-9986-5324)
...
DigitalSoma v2.1.0 adds a native HL7 FHIR R4 I/O layer through the `digitalsoma.fhir` subpackage. It is a zero-dependency implementation — pure Python standard library, no `fhir.resources` package required.
...
*DigitalSoma v2.1.0 — Dr. ir. Ali Youssef (ORCID: 0000-0002-9986-5324), Agroecosystems Laboratory, University of Manitoba & BioTwinR Ltd., Winnipeg, Canada. CC BY 4.0.*
